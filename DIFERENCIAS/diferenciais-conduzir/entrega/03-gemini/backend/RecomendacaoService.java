 ...
 *
 * Isso e um algoritmo classico de "recomendacao por similaridade" -
 * o mesmo tipo de logica usada (de forma bem mais complexa) por
 * Netflix, Amazon, etc. Aqui fizemos uma versao simples e didatica.
 *
...
public class RecomendacaoService {
    ...
    private final GeminiService geminiService; // pode ser null-safe (ver isConfigured())
    ...
    public RecomendacaoResponseDTO recomendar(RecomendacaoRequestDTO pedido) {
        ...
        // Tenta gerar uma explicacao em linguagem natural com o Gemini.
        // Se nao estiver configurado (sem chave) ou der erro, usa um resumo simples.
        String resumo;
        boolean geradoPorIA;
     ...
     * Total maximo = 100 pontos (todos os criterios batendo).
     */
    private VeiculoRecomendadoDTO calcularPontuacao(Veiculo v, RecomendacaoRequestDTO pedido) {
        ...
        // Cor (comparacao sem diferenciar maiusculas/minusculas)
        ...
        // Modelo (aceita correspondencia parcial, ex: "corolla" bate com "Corolla Cross")
        ...
        // Se nenhum criterio foi informado, todos empatam com pontuacao base
