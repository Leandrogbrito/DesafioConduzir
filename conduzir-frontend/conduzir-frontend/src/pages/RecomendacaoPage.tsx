    ...
    <div className="card">
      ...
      {resultado && (
        <div style={{ marginTop: 28 }}>
          <div style={{ background: '#eef6ff', borderLeft: '4px solid #1e5a9e', padding: '14px 18px', borderRadius: 8, marginBottom: 20 }}>
            ...
            <table>
              ...
              <tbody>
                {resultado.recomendacoes.map((r, i) => (
                  <tr key={i}>
                    <td>
                      <span className="badge" style={{ background: r.pontuacao >= 70 ? '#e6f7f3' : '#fff7ed', color: r.pontuacao >= 70 ? '#2ec4a6' : '#f59e0b' }}>
                        {r.pontuacao}%
                      </span>
                    </td>
